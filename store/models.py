...
class DataBundle(models.Model):
    ...
    data_amount = models.CharField(max_length=50, blank=True)  # e.g., "10GB", "Unlimited"
    validity = models.CharField(max_length=50, blank=True)  # e.g., "30 days", "Monthly"
...
class Order(models.Model):
    ...
    product_id = models.IntegerField()  # ID of either bundle or router
